...
var __VLS_35;
var __VLS_3;
/** @type {[typeof PlaybackControls, ]} */ ;
// @ts-ignore
const __VLS_44 = __VLS_asFunctionalComponent(PlaybackControls, new PlaybackControls({}));
...
if (__VLS_ctx.store.result) {
    ...
    // @ts-ignore
    const __VLS_47 = __VLS_asFunctionalComponent(SpectrumPlot, new SpectrumPlot({}));
...
if (__VLS_ctx.store.result) {
    ...
    // @ts-ignore
    const __VLS_53 = __VLS_asFunctionalComponent(WaterfallPlot, new WaterfallPlot({}));
    const __VLS_54 = __VLS_53({}, ...__VLS_functionalComponentArgsRest(__VLS_53));
}
if (__VLS_ctx.store.result) {
    /** @type {[typeof ModulationResult, ]} */ ;
    // @ts-ignore
    const __VLS_56 = __VLS_asFunctionalComponent(ModulationResult, new ModulationResult({}));
